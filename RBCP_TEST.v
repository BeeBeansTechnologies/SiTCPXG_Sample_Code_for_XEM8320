...
*                                                                                               *
* history     :                                                                                 *
*				20260407	Ver 1.1		---------	Created by BBT for XEM8320_SiTCP_XG_EEPROM  *
*                                                                                               *
************************************************************************************************/
module
	RBCP_TEST(
...
//--------------------------------------
	...
	always	@(posedge CLK) begin
		irAddr[7:0]	<= (LOC_ADDR[15:8] == 8'd0000_0000)?	LOC_ADDR[7:0]:		irAddr[7:0]		;
...
//--------------------------------------
	...
	assign	regX05Data[7:0]		= 8'b0000_0000;
	...
	assign	X05Data[7:0]	= regX05Data[7:0];
...
//--------------------------------------
	...
	always@ (posedge CLK) begin
		...
		PreMuxData[ 7: 0]	<= (
			...
			((irAddr[2:0] == 3'd5)?	X05Data[7:0]:		8'h00)
		);
		PreMuxData[15: 8]	<= (
